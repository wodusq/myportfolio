      ...
      <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            ...
            <Modal show={showModal} onClose={()=> setShowModal(false)}>
              <p className='pt-10'> michal.lalecki@hotmail.com</p>
              <p className='pt-10'><a href='https://github.com/wodusq' target="_blank"> <AiFillGithub />Github</a>
              <a href='https://www.linkedin.com/in/micha%C5%82-lalecki-5848881b8/' target="_blank"><AiFillLinkedin /></a></p>
            </Modal>
          </nav>
