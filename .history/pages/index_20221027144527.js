      ...
      <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            ...
            <Modal show={showModal} onClose={()=> setShowModal(false)}>
              ...
              <p className='pt-10 text-teal-600 font-medium'><a href='https://github.com/wodusq' > GitHub </a></p>
              <p className='pt-5 text-teal-600 font-medium'><a href='https://www.linkedin.com/in/micha%C5%82-lalecki-5848881b8/' > LinkedIn </a></p>
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <a href='https://github.com/wodusq'  > <AiFillGithub /></a>
        ...
        <section>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://m4rk37.com/'  className='cursor-pointer'><Image alt='web1'  className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src="/web1.jpg"/>
              ...
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://ecommerce-wodusq.vercel.app/?fbclid=IwAR1K5AK4-P7jqclpd49rm2H7fqdM7sTL2iGGrRmuPYev0UaVFSvsoAicfys'  className='cursor-pointer'><Image alt='web2' className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src="/web2.jpg"/>
                <div className='rounded-lg image-overlay image-overlay-blur '>
              ...
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://wodusq.github.io/three-js-app/?fbclid=IwAR2x-q25o4RxuXxAlDm8y2WF-TzKs5mv-scAn5FvALPwZkLaY_ma_nFgDfQ' className='cursor-pointer'><Image alt='web3' className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src="/web3.jpg"/>
                <div className='rounded-lg image-overlay image-overlay-blur '>
