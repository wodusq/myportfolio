      ...
      <section className="min-h-screen">
        ...
        <section>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
              ...
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://ecommerce-wodusq.vercel.app/?fbclid=IwAR1K5AK4-P7jqclpd49rm2H7fqdM7sTL2iGGrRmuPYev0UaVFSvsoAicfys'  className='cursor-pointer'><Image  className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src={web2}/>
                <div className='rounded-lg image-overlay image-overlay-blur '>
                  <h3>Streetwear apparel site</h3>
                  <p>Site was made as wordpress theme</p>
                  <p className='px-5'>Technology i used is bootstrap, html, javascript, scss and more </p>
              ...
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://wodusq.github.io/three-js-app/?fbclid=IwAR2x-q25o4RxuXxAlDm8y2WF-TzKs5mv-scAn5FvALPwZkLaY_ma_nFgDfQ'  className='cursor-pointer'><Image  className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src={web3}/>
                <div className='rounded-lg image-overlay image-overlay-blur '>
                  <h3>Streetwear apparel site</h3>
                  <p>Site was made as wordpress theme</p>
                  <p className='px-5'>Technology i used is bootstrap, html, javascript, scss and more </p>
              ...
              <div className= 'basis-1/3 flex-1 relative text-center'>
                <a href='https://github.com/wodusq' className='cursor-pointer'><Image  className='rounded-lg object-cover' width={'100%'} height={'100%'} layout='responsive' src={web4}/>
                <div className='rounded-lg image-overlay image-overlay-blur '>
                  <h3>Streetwear apparel site</h3>
                  <p>Site was made as wordpress theme</p>
                  <p className='px-5'>Technology i used is bootstrap, html, javascript, scss and more </p>
