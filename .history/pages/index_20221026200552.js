          ...
          <div className={`${styles.block} ${(magicSectionIsVisible) ? styles.animateBlock : ''}`}>
            <h2 ref={magicSectionRef} className={styles.heading}>
              <div className="lg:flex gap-20">
                <div ref={myRef} className="text-center display-flex justify-center align-items-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
                  
                  <h3 className="text-lg font-medium pt-8 pb-2  ">
                  
                    Beautiful Designs <BsCodeSlash/>
                  </h3>
                  <p className="py-2">
